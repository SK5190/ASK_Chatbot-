...
import { Eye, EyeOff, Mail, Lock, User, Bot, Sun, Moon } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-200 ${
      ...
      <button
        onClick={() => {
          console.log('Register page toggle clicked, current theme:', isDarkMode);
          toggleTheme();
        }}
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className={`mt-2 text-sm ${
            ...
            Join Ask-Bot and start chatting with AI
          </p>
        </div>
